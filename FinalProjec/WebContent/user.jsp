            ...
            <div class="page-content d-flex align-items-stretch">
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="customer.jsp"><i class="fa fa-users"></i>Customer</a></li>
                       
                        <li class="active"><a href="user.jsp"><i class="fa fa-user"></i>User</a></li>
                                    ...
                                    <form id="form">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input id="user_id" type="hidden" class="form-control" value="0" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Name</label>
                                                    <input id="name" type="text" onkeypress="onclickvalidateName()" class="form-control" placeholder="Name" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="update ml-auto mr-auto">
                                                <button onclick="save()" type="button" class="btn btn-success btn-round">Save User</button>
                                                <button onclick="update()" type="button" class="btn btn-success btn-round">Update User</button>
                                                <button onclick="delet()" type="button" class="btn btn-success btn-round">Delete User</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
