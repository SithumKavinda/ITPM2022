          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                    <label class="label-material" style="color: red">${authentication}</label>
                    ...
                    </form><small>Don't Have an account? </small><a href="customer_registration.jsp" class="signup">SignIn</a>
                </div>
              </div>
            </div>
          </div>
