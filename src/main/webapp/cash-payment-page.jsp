...
<!-- Test css -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/style/payment/test.css" />
...
<script type="text/javascript">
	...
	function validate() {
		...
		if (paid.value == null || paid.value == "") {
			error.innerText = "Cannot leave empty";
			loadError();
	...
	function calculate() {
		...
		if (paid.value != "" || paid.value != null) {
			var bal = paid.value - total;
			balance.value = bal.toFixed(2);
		} else {
			paid.style.border = "1px solid yellow";
		}
	}
</script>
</head>
			...
			<form id="cashForm" action="error" name="cashForm" method="post"
				...
				<div class="inline-lable-input">
					...
					<div class="total-amount">
						<input class="custom-input" id="total-amount" name="total-amount"
				...
				<div class="inline-lable-input">
					...
					<div class="paid-amount">
						<input class="custom-input" id="paidamount" name="paidAmount"
							type="number" placeholder="Enter Paid Amount"
							oninput="validate()" onchange="calculate()" />
					</div>
					<div></div>
					<div id="error" class="alert alert-danger" role="alert">This
				...
				<div class="inline-lable-input">
					...
					<div class="balance-amount">
						<input class="custom-input" id="balance-amount"
							name="balance-amount" type="text" value="-" readonly />
					</div>
				</div>
